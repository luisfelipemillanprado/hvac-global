import type { FeaturedServiceTagsProps } from '@/common/service/types'
...
export const FeaturedServiceTags = ({ tags }: FeaturedServiceTagsProps) => {
  return (
    <div className="grid grid-cols-2 gap-4">
      {tags.map((tag) => (
        <div key={tag} className="bg-lilac-light flex h-10 w-full min-w-0 items-center rounded-full px-4">
